<?php
require "validacoes/config.php"; // Verifique o caminho correto do arquivo
...
?>
  ...
  <div class="container">
    ...
    <div class="row">
        ...
        $sql = "SELECT id, titulo, autoria, imgCapa FROM jogos"; // Substitua "jogos" pelo nome da sua tabela de jogos
        ...
        <div class="col-lg-6">
            <div class="item">
                <img src="assets/images/jogos/<?php echo $jogo['imgCapa']; ?>" alt="" class="templatemo-item">
                <h4><?php echo $jogo['titulo']; ?></h4>
                <span><?php echo $jogo['autoria']; ?></span>
                <ul>
                    <li><a href="jogar.php?id=<?php echo $jogo['id']; ?>"><i class="bi bi-play-fill"></i> Jogar</a></li>
                </ul>
            </div>
        </div>
        <?php
