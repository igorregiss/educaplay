                ...
                <table class='table align-items-center mb-0'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a class='btn btn-link text-danger text-gradient px-3 mb-0' href='acoes/del-categorias.php?id=$id'><i class='far fa-trash-alt me-2'></i>Excluir</a>
                      <a class='btn btn-link text-dark px-3 mb-0' href='editar_categoria.php?id=$id'><i class='fas fa-pencil-alt text-dark me-2' aria-hidden='true'></i>Editar</a>
                      </td>
                    </tr>
                    ";
                    }
