      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Videos</li>
          </ol>
        </nav>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">AUTORIA</th>
                      <th class="text-secondary opacity-7"></th>
                      <th  class="align-middle text-end text-dark text-dark text-xxg font-weight-bolder"><a href="add-jogos.php">Adicionar Livro +</a></th>

                    </tr>
                  </thead>
                  <tbody>
                  <?php
$sql = 'SELECT jogos.id, jogos.idCategoria, jogos.titulo, jogos.iframe, jogos.imgCapa, jogos.autoria, categorias.descricao AS categoria_descricao FROM jogos
        INNER JOIN categorias ON jogos.idCategoria = categorias.id
        ORDER BY jogos.id DESC';
...
foreach ($result as $r) {
    ...
    <tr>
        ...
        <td>
            <div class='d-flex px-2 py-1'>
                <div class='d-flex flex-column justify-content-center'>
                    <h6 class='mb-0 text-sm' id='autoria' name='autoria'>$autoria</h6>
                </div>
            </div>
        </td>
        ...
        <td class='align-middle text-end'>
            <a class='btn btn-link text-danger text-gradient px-3 mb-0' href='acoes/del-jogos.php?id=$id'><i class='far fa-trash-alt me-2'></i>Excluir</a>
            <a class='btn btn-link text-dark px-3 mb-0' href='editar-jogos.php?id=$id'><i class='fas fa-pencil-alt text-dark me-2' aria-hidden='true'></i>Editar</a>
        </td>
    </tr>
    ";
}
