                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      ...
                      <?php
// Certifique-se de que a conexão com o banco de dados está aberta (você deve ter uma conexão aberta antes deste trecho)
...
?>
                      ...
                      <span class="text-xs"><?php echo "$totalUsuarios usuário(s) cadastado(s)"; ?></span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto" href="usuarios.php"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                  </div>
                </li>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Categorias</h6>
                      <?php 
                          ...
                          ?>
                      <span class="text-xs"><?php echo "$totalCategorias categoria(s) cadastrada(s)";?></span>
                    </div>
                  </div>
                  <div class="d-flex">
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <div class="icon icon-shape icon-sm me-3 bg-dark shadow text-center">
                      <i class="ni ni-tag text-white opacity-10"></i>
                    </div>
                    
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Livros</h6>
                      <?php 
                            ...
                            if ($result) {
                              $row = mysqli_fetch_assoc($result);
                              $totalLivros = $row['total'];
                            }
                          ?>
                      <span class="text-xs"><?php echo "$totalLivros Livros cadastrados";?></span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <div class="icon icon-shape icon-sm me-3 bg-info shadow text-center">
                      <i class="ni ni-single-copy-04 text-white opacity-10"></i>
                    </div>
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Video-aulas</h6>
                      <?php 
                            $sql = "SELECT COUNT(*) AS total FROM videoaula";
                            $result = mysqli_query($conexao, $sql);

                            $totalVideoaula = 0;
                            if ($result) {
                              $row = mysqli_fetch_assoc($result);
                              $totalVideoaula = $row['total'];
                            }
                          ?>
                      <span class="text-xs"><?php echo "$totalVideoaula Video-aulas cadastrados";?></span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
                ...
                <li class="list-group-item border-0 d-flex justify-content-between ps-0 border-radius-lg">
                  <div class="d-flex align-items-center">
                    <div class="icon icon-shape icon-sm me-3 bg-danger shadow text-center">
                      <i class="ni ni-chat-round text-white opacity-10"></i>
                    </div>
                    <div class="d-flex flex-column">
                      <h6 class="mb-1 text-dark text-sm">Jogos</h6>
                      <?php 
                          ...
                          ?>
                      <span class="text-xs font-weight-bold"><?php echo "$totalJogos Jogos cadastrados";?></span>
                    </div>
                  </div>
                  <div class="d-flex">
                    <button class="btn btn-link btn-icon-only btn-rounded btn-sm text-dark icon-move-right my-auto"><i class="ni ni-bold-right" aria-hidden="true"></i></button>
