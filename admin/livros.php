                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">EDIÇÃO</th>
                      <th class="text-secondary opacity-7"></th>
                      <th  class="align-middle text-end text-dark text-dark text-xxg font-weight-bolder"><a href="add-livros.php">Adicionar Livro +</a></th>

                    </tr>
                  </thead>
                  <tbody>
                  <?php
$sql = 'SELECT livros.id, livros.titulo, livros.edicao, categorias.descricao AS categoria_descricao FROM livros
...
foreach($result as $r) {
    ...
    <tr>
        ...
        <td>
            <div class='d-flex px-2 py-1'>
                <div class='d-flex flex-column justify-content-center'>
                    <h6 class='mb-0 text-sm' id='id' name='id'>$titulo</h6>
                </div>
            </div>
        </td>
        ...
        <td class='align-middle text-center'>
            <span class='text-secondary text-xs font-weight-bold' id='edicao' name='edicao'>$edicao</span>
        </td>
        <th class='text-secondary opacity-7'></th>
        <td  class='align-middle text-end '>
            <a class='btn btn-link text-danger text-gradient px-3 mb-0' href='acoes/del-livros.php?id=$id'><i class='far fa-trash-alt me-2'></i>Excluir</a>
            <a class='btn btn-link text-dark px-3 mb-0' href='editar-livros.php?id=$id'><i class='fas fa-pencil-alt text-dark me-2' aria-hidden='true'></i>Editar</a>
        </td>
    </tr>
    ";
}
