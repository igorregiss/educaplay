...
<body class='g-sidenav-show   bg-gray-100'>
  ...
  <i class="fa fa-sign-out fixed-plugin-button-nav cursor-pointer"></i>
    ...
    <!-- End Navbar -->
    <form id='form-cadastro' action='acoes/cad-livros.php' method='POST' enctype='multipart/form-data'>
        ...
        <div class='row'>
            <div class='col-md-12'>
                <div class='card'>
                    ...
                    <div class='card-body'>
                        <p class='text-uppercase text-sm'>Adicionar Livro</p>
                        <?php
                        if(isset($_GET['msg'])){
                            $msg = $_GET['msg'];
                            if($msg == "sucesso"){
                                ...
                                <div class='alert alert-danger'>
                                    Ops! Erro ao cadastrar o novo livro!
                                </div>
                                ";
                            }
                        }
                        ...
                        <div class='row'>
                            <div class='col-md-12'>
                                <div class='form-group'>
                                    ...
                                    <textarea class='ckeditor form-control' name='descricao' id='descricao' rows='4'></textarea>
                                </div>
                            </div>
                            <div class='col-md-6'>
                                <div class='form-group'>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    ...
                                    <input class='form-control' type='text' name='edicao' id='edicao'>
                                </div>
                            </div>
                        </div>
