...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <i class="fa fa-sign-out fixed-plugin-button-nav cursor-pointer"></i>
    ...
    <form class="row g-3" method="POST" action="acoes/update-categoria.php">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <p class="text-uppercase text-sm">Editar Categoria</p>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="descricao" name="descricao" value="<?php echo $nome ?>">
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="text-center">
                    <button class="btn btn-lg btn-primary btn-lg" href="./usuarios.php">Salvar</button>
                  </div>
                </div>
              </div>
            </div>
