...
<body class='g-sidenav-show   bg-gray-100'>
  ...
  <i class="fa fa-sign-out fixed-plugin-button-nav cursor-pointer"></i>
    ...
    <!-- End Navbar -->
    <form id='form-cadastro' action='acoes/cad-jogos.php' method='POST' enctype='multipart/form-data'>
    <div class='container-fluid py-4'>
        ...
        Jogo cadastrado com sucesso!
                            ...
                            echo "
                                ...
                                Ops! Erro ao cadastrar a novo jogo!
                                </div>
                            ";
                        }
                    }
                        ...
                        <div class='row'>
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    ...
                                    <input class='form-control' type='text' name='autoria' id='autoria'>
                                </div>
                            </div>
                        </div>
