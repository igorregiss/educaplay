...
<body class='g-sidenav-show   bg-gray-100'>
      ...
      <div class='container-fluid py-1 px-3'>
        <nav aria-label='breadcrumb'>
          <ol class='breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5'>
            ...
            <li class='breadcrumb-item text-sm text-white active' aria-current='page'>Video Aulas</li>
          </ol>
        </nav>
  ...
  <i class="fa fa-sign-out fixed-plugin-button-nav cursor-pointer"></i>
    ...
    <!-- End Navbar -->
    <form id='form-cadastro' action='acoes/cad-videos.php' method='POST' enctype='multipart/form-data'>
    <div class='container-fluid py-4'>
        <div class='row'>
            <div class='col-md-12'>
                <div class='card'>
                    ...
                    <div class='card-body'>
                        <p class='text-uppercase text-sm'>Adicionar Video</p>
                        <?php
                    if(isset($_GET['msg'])){
                        $msg = $_GET['msg'];
                        if($msg == "sucesso"){
        ...
        Video-aula cadastrada com sucesso!
        </div>
                            ";
                            ...
                            echo "
                                ...
                                Ops! Erro ao cadastrar a nova video-aula!
                                </div>
                            ";
                        }
                    }
                ...
                ?>
                                    ...
                                    <select class='form-control' name='idCategoria' id='idCategoria'>
                                        ...
                                        if ($result) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<option value='$idCategoria'>$descricao</option>";
                                            }
                                        } else {
                        ...
                        <div class='row'>
                            <div class='col-md-12'>
                                <div class='form-group'>
                                    ...
                                    <textarea class='form-control' name='iframe' id='iframe' rows='4'></textarea>
                                </div>
                            </div>
                            <div class='col-md-6'>
                                <div class='form-group'>
                        ...
                        <div class='row'>
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    <label for='creditos' class='form-control-label'>Créditos</label>
                                    <input class='form-control' type='text' name='creditos' id='creditos'>
                                </div>
                            </div>
                        </div>
