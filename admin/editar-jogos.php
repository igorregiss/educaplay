...
function processarUploadImagem($id) {
    if (isset($_FILES['novaImgCapa']['name']) && !empty($_FILES['novaImgCapa']['name'])) {
        ...
        if (move_uploaded_file($_FILES['novaImgCapa']['tmp_name'], $uploadFile)) {
            ...
            global $conexao;
            $sql = "UPDATE jogos SET imgCapa = ? WHERE id = ?";
...
<body class='g-sidenav-show   bg-gray-100'>
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="jogos.php">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class='main-content position-relative border-radius-lg '>
        ...
        <!-- End Navbar -->
        <form id='form-edicao' action='acoes/update-jogos.php' method='POST' enctype='multipart/form-data'>
                                ...
                                <div class='row'>
                                            ...
                                            <select class='form-control' name='idCategoria' id='idCategoria'>
                                                ...
                                                if ($result) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        $selected = ($idCategoria == $jogos['idCategoria']) ? 'selected' : '';
                                    ...
                                    <div class='col-md-6'>
                                        <div class='form-group'>
                                            ...
                                            <input class='form-control' type='text' name='titulo' id='titulo' value="<?php echo $jogos['titulo']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class='row'>
                                    <div class='col-md-12'>
                                        ...
                                        <input class='form-control' type='text' name='iframe' id='iframe' value="<?php echo $jogos['iframe']; ?>">
                                        </div>
                                    </div>
                                    </div>
                                <div class='row'>
                                    ...
                                    <div class='col-md-6'>
                                        <div class='form-group'>
                                            <label for='autoria' class='form-control-label'>Autoria</label>
                                            <input class='form-control' type='text' name='autoria' id='autoria' value="<?php echo $jogos['autoria']; ?>">
                                        </div>
                                    </div>
                                </div>
